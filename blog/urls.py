...
urlpatterns = [
	...
	url(r'^AboutMe/', views.AboutMe, name ='AboutMe_link'),  #For pages under construction.
	url(r'^Contact/', views.contact_form, name='contact_link'),
	url(r'^Thanks/', views.thanks, name='thanks'),
	url(r'^ResourceCenter_Definitions/', views.ResCenter_Def, name='ResCenter_link'),
	url(r'^ResourceCenter_Links/', views.ResCenter_Links, name='ResCenter_Links_link'),
